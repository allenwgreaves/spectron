...
Application.prototype.start = function () {
  ...
  return self.exists()
    ...
    .then(function () { return self.client.setTimeout({ 'script': self.waitTimeout }) })
...
Application.prototype.stop = function () {
  ...
  return new Promise(function (resolve, reject) {
    var endClient = function () {
      setTimeout(function () {
        self.client.deleteSession().then(function () {
    ...
    if (self.api.nodeIntegration) {
      ...
      self.client.windowByIndex(0).then(function () {
...
Application.prototype.addCommands = function () {
  ...
  this.client.addCommand('executePromise', function (exec, args) {
    var self = this
    return new Promise(function (resolve) {
      return self.execute(exec, args).then(function (result) {
        resolve({value: result})
      })
      // var executeResult = exec.bind(self)()
    })
  })
  ...
  this.client.addCommand('getRenderProcessLogs', function () {
    return this.getLogs('browser').then(getResponseValue)
  })
